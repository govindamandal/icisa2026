...
function OrganisedBy() {
  return (
    <section id="organised-by" className="bg-primary10">
        <div className="container mx-auto px-6 py-12">
            ...
            <div className="flex flex-1 items-center flex-col space-y-3">
                ...
                <h3 className="text-xl font-bold text-center md:text-2xl pt-4 hidden">National Institute of Technology, Delhi</h3>
                <p className="flex items-center flex-1 text-justify flex-col space-y-3">National Institute of Technology Delhi is a premier public technical autonomous institution located in New Delhi. NIT Delhi is an Institution of National Importance and aims to provide instructions and research facilities in various disciplines of Engineering, Science and Technology, Management, Social Sciences and Humanities for advance learning and dissemination of knowledge. The mission of NIT Delhi is to produce human resource those who are creative, competitive, and innovative with high intellect and ethical values.</p>
            </div>
            </div>
        </div>
    </section>
